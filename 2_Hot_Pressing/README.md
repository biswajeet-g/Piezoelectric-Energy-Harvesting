...
| Materials | Usage |
|--------|----------|
| Plastic Coatings - 2| To protect the piezoelectric sheet under pressure |
...
## Steps involved
 ...
 2. The sheet was placed in between two plasitic sheets and in between two heatd plates.
 3. the it was pressed on the hot press machine (Hydraluc hot press).
 4. The pressure is applied upto 50HPa and kept in the temperature upto 150*C (fixed).
 5. Initally, the temperature gradually increased from 40*C to 150*C+.
 6. The heated plates are then cooled down by removed the composite plates.
