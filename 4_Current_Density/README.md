...
### For Data Collection
  ...
  - Set no. of turns as 10 and remove the capacitor.
  - Click on apply -> Current Density (it would take some time and it showed different graphical plots describing current density at different fields
  - Chose the appropriate graphs and saved it in a location.

### For data analysis
  #### Steps for setting up files
    - To open excelsheet for Pe Loop readings:
      - Open -> Computer -> 2.5%(e.g.) -> leakage current -> 400 KV
...
#### Steps for setting up Origin 2021
    ...
    - Initially, 'C' i.e Current Density kept the Y-axis and 'E' i.e Electric field kept the X-axis.
